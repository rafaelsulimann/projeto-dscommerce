...
public interface OrderItemRepository extends JpaRepository<OrderItem, Long> {
    ...
    @Query(nativeQuery = true, value = "SELECT tb_products.id, tb_products.name, tb_order_items.price, tb_order_items.quantity, SUM(tb_order_items.price * tb_order_items.quantity) AS subTotal "
    + "FROM tb_order_items "
